...
if ( function_exists( 'is_plugin_active' ) && is_plugin_active( 'intuitive-custom-post-order/intuitive-custom-post-order.php' ) ) {
	...
	$just_theme = str_replace( $theme_path, '', $full_path );
	define( 'HICPO_URL', get_stylesheet_directory_uri() . $just_theme );
	define( 'HICPO_DIR', $full_path );
}
...
class Hicpo {
	function __construct() {
		if ( !get_option( 'hicpo_activation' ) ) {
